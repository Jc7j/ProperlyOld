...
import { generateId } from '~/components/table/utils/id'
import { getFiltersStateParser } from '~/components/table/utils/parsers'
...
function DataTableFilterItem<TData>({
...
}: DataTableFilterItemProps<TData>) {
  {
    ...
    const onItemKeyDown = React.useCallback(
      ...
      [filter.filterId, showFieldSelector, showValueSelector, onFilterRemove]
    )
    ...
    return (
      ...
      >
        ...
        >
          ...
          {filterOperators.map((operator: any) => (
    ...
    case 'boolean': {
      return (
        <Select
          ...
          className="h-8 rounded-none border px-2.5 [&[data-size]]:h-8 [&_svg]:hidden"
        >
